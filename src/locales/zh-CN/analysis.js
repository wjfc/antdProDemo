export default {
  ...
  'app.analysis.use': '节点使用',
  'app.analysis.introduce': '指标说明',
  'app.analysis.total-sales': '总销售额',
  'app.analysis.day-sales': '日销售额',
  'app.analysis.video-used': '视频对讲能力本月已使用分钟数',
  'app.analysis.wechat-used': '微信采集能力剩余可使用天数',
  ...
  'app.analysis.total-cost': '总参考成本',
  'app.analysis.total-expend': '总支出',
};
