export default {
  'app.login.userName': '帐号',
  'app.login.password': '6-16位密码，区分大小写',
  'app.validation.verification-code': '请输入验证码',
  ...
  'validation.username.required': '请输入用户名!',
  'validation.roleName.required': '请输入角色名!',
  'validation.password.required': '请输入密码！',
  'validation.querycode.required': '请输入验证码！',
